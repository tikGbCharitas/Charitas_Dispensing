...
public partial class tmp_bill_interm5
{
    ...
    public decimal? CPriceTemp { get; set; }
    ...
    public decimal? iGuarantorAmount { get; set; }

    public decimal? iGuarantorDiscountAmount { get; set; }

    public decimal? iPatientAmount { get; set; }

    public decimal? iPatientDiscountAmount { get; set; }
}
